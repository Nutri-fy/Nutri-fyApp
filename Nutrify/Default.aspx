        ...
        <div>
            ...
            <asp:Panel ID="pnlLogin" class="form-group" runat="server" BorderColor="White" Enabled="False" Visible="False">
                    ...
                    <div id="loginControls" aria-autocomplete="none">
                        ...
                        <asp:CompareValidator ID="cmpUserName" runat="server" ErrorMessage="Incorrect Username or Password" ControlToCompare="txtHiddenUsername" ControlToValidate="txtUsername" ForeColor="Red" Display="Dynamic"></asp:CompareValidator>
                        <br />
            ...
            <asp:Panel ID="pnlRegister" class="form-group" runat="server" BorderColor="White">
                    ...
                    <div class="row">
                        <div id="col5" class="col">
                            ...
                            <asp:TextBox ID="txtRegPassword" class="form-control" TextMode="Password" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="ReqRegPass" runat="server" ControlToValidate="txtRegPassword" Display="Dynamic" ErrorMessage="Please enter a Password" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row">
                        <div id="col6" class="col">
                            <label for="txtRePassword">Re-enter Password</label>
                            <asp:TextBox ID="txtRePassword" class="form-control" TextMode="Password" runat="server"></asp:TextBox>
                            <asp:CompareValidator ID="compPass" runat="server" ControlToCompare="txtRegPassword" Display="Dynamic" ControlToValidate="txtRePassword" ErrorMessage="Passwords must match!" ForeColor="#3333FF"></asp:CompareValidator>
                        </div>
                    </div>
                    <br />
